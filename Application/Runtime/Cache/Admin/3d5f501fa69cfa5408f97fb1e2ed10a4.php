							...
							<div class="col-xs-12">
								...
								<form id="form" method="post" action="<?php echo U('del');?>">
									...
									<?php if(is_array($linkList)): $i = 0; $__LIST__ = $linkList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
											<td class="center">
												<input class="aids" type="checkbox" name="id[]" value="<?php echo ($vo['id']); ?>">
											</td>
											<td><?php echo getcategory($vo['cid']);?></td>
											<td><?php echo ($vo['title']); ?></td>
											<td><?php echo $vo['author'];?></td>
											<td><?php echo gettime($vo['publishtime']);?></td>
											<td><?php echo gettime($vo['updatetime']);?></td>
											<td><?php echo $vo['views'];?></td>
											<td>
												<a class="blue" href="<?php echo U('add');?>">
													<i class="icon-zoom-in bigger-130"></i>
												</a>

												<a class="green" href="<?php echo U('edit',array('id'=>$vo['id']));?>">
													<i class="icon-pencil bigger-130"></i>
												</a>

												<a class="red" href="<?php echo U('del',array('id'=>$vo['id']));?>">
